...
CREATE TYPE SECTION_TYPE AS ENUM('smyčce', 'dechy', 'ostatní');
...
CREATE TABLE Events(
	...
	AddrInstition		VARCHAR(255) NULL,
	AddrStreet			VARCHAR(64) NULL,
	AddrHouseNumber		VARCHAR(32) NULL,
...
WITH rows AS (INSERT INTO Users(Email, Passwd, FirstName, FamilyName, BirthDate, Phone) 
			  VALUES ('admin@smartorchestra.net', '$2a$12$S3CxfM6NX3QQBg3K4jPOc.IWVIs7UtAIzi3cPIxMpqgAlVw5.rugm',
					  'Super', 'Administrator', CURRENT_DATE, '+420 620 123 123 123') RETURNING Uid)
	INSERT INTO Administrators(Uid) VALUES ((SELECT Uid FROM rows));

GRANT ALL ON TABLE public.administrators TO db19_bartom47;

GRANT ALL ON TABLE public.events TO db19_bartom47;

GRANT ALL ON TABLE public.participants TO db19_bartom47;

GRANT ALL ON TABLE public.player TO db19_bartom47;

GRANT ALL ON TABLE public.sections TO db19_bartom47;

GRANT ALL ON TABLE public.users TO db19_bartom47;
